...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-5 d-block"
            ...
            <div class="container"><a class="navbar-brand" href="index.html"><img src="frontend/assets/img/logo.svg"
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
                        <h4 class="fw-bold text-danger mb-3">Taman Kanak-Anak</h4>
                        <h1 class="hero-title">Kuncup Bahari</h1>
                            ...
                            <div class="w-100 d-block d-md-none"></div><a href="#!" role="button"
                                data-bs-toggle="modal" data-bs-target="#popupVideo"><span
                                    class="btn btn-danger round-btn-lg rounded-circle me-3 danger-btn-shadow"> <img
                                        src="frontend/assets/img/hero/play.svg" width="15"
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="frontend/assets/img/dest/dest1.jpg" alt="Rome, Italty" />
                            <div class="card-body py-4 px-3">
                                ...
                                <div class="d-flex align-items-center"> <img
                                        src="frontend/assets/img/dest/navigation.svg" style="margin-right: 14px"
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="frontend/assets/img/dest/dest2.jpg" alt="London, UK" />
                            <div class="card-body py-4 px-3">
                                <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                                    <h4 class="text-secondary fw-medium"><a
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card overflow-hidden shadow"> <img class="card-img-top"
                                src="frontend/assets/img/dest/dest3.jpg" alt="Full Europe" />
                            <div class="card-body py-4 px-3">
                                <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                                    <h4 class="text-secondary fw-medium"><a
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-primary me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="frontend/assets/img/steps/selection.svg" width="22" alt="steps" />
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-danger me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="frontend/assets/img/steps/water-sport.svg" width="22" alt="steps" />
                            </div>
                            <div class="flex-1">
                        ...
                        <div class="d-flex align-items-start mb-5">
                            <div class="bg-info me-sm-4 me-3 p-3" style="border-radius: 13px"> <img
                                    src="frontend/assets/img/steps/taxi.svg" width="22" alt="steps" /></div>
                            <div class="flex-1">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-start">
                        <div class="card position-relative shadow" style="max-width: 370px;">
                            <div class="position-absolute z-index--1 me-10 me-xxl-0" style="right:-160px;top:-210px;">
                                <img src="frontend/assets/img/steps/bg.png" style="max-width:550px;"
                                    alt="shape" />
                            </div>
                            <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100"
                                    src="frontend/assets/img/steps/booking-img.jpg" alt="booking" />
                                <div>
                                    ...
                                    <div class="icon-group mb-4"> <span class="btn icon-item"> <img
                                                src="frontend/assets/img/steps/leaf.svg" alt="" /></span><span
                                            class="btn icon-item"> <img src="frontend/assets/img/steps/map.svg"
                                                alt="" /></span><span class="btn icon-item"> <img
                                                src="frontend/assets/img/steps/send.svg" alt="" /></span>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center mt-n1"><img class="me-3"
                                                src="frontend/assets/img/steps/building.svg" width="18"
                                        ...
                                        <div class="show-onhover position-relative">
                                                ...
                                                <div class="card-body py-3">
                                                    <div class="d-flex">
                                                        <div style="margin-right: 10px"> <img class="rounded-circle"
                                                                src="frontend/assets/img/steps/favorite-placeholder.png"
                                            ...
                                            <button class="btn"> <img src="frontend/assets/img/steps/heart.svg"
                    ...
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="frontend/assets/img/partner/1.png" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="frontend/assets/img/partner/2.png" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="frontend/assets/img/partner/3.png" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="frontend/assets/img/partner/4.png" alt="" /></div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-hover mb-4" style="border-radius:10px;">
                            <div class="card-body text-center"> <img class="img-fluid"
                                    src="frontend/assets/img/partner/5.png" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img class="mb-4"
                            src="frontend/assets/img/logo2.svg" width="150" alt="jadoo" />
                    ...
                    <div class="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
                        ...
                        <div class="d-flex align-items-center"> <a href="#!"> <img class="me-2"
                                    src="frontend/assets/img/play-store.png" alt="play store" /></a><a
                                href="#!"> <img src="frontend/assets/img/apple-store.png"
